        ...
        <div className=" mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-montserrat text-2xl font-bold">FITIN</span>
            </div>

            {/* Navigation Links */}
            <div className="font-montserrat hidden md:flex items-center gap-8">
              <a href="#home" className="text-gray-300 hover:text-lime-400 transition-colors">
                Home
              </a>
              ...
              <a href="#service" className="text-gray-300 hover:text-lime-400 transition-colors">
                Contact
              </a>
            </div>
